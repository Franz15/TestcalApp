                ...
                <table width="600" style="background-color: #ffffff; border: 1px solid #e6e6e6; border-radius: 4px; box-shadow: 0 0 10px rgba(0,0,0,0.1);">
                    ...
                    <tr>
                        <td style="padding: 20px;">
                            ...
                            <p><a href= https://api.testcalapp.es/api/user/confirmed/${token} style="background-color: rgb(232,191,86); color: #fff; padding: 10px 20px; text-decoration: none; border-radius: 4px;">Verificar Correo Electrónico</a></p>
                            <p>Si no has creado una cuenta en TestcalApp, puedes ignorar este correo electrónico.</p>
                        </td>
                    </tr>
                    <tr>
                        <td style="background-color: #f4f4f4; padding: 20px; text-align: center;">
                            <p>Si tienes algún problema al hacer clic en el botón de verificación, copia y pega el siguiente enlace en tu navegador: https://api.testcalapp.es/api/user/confirmed/${token}</p>
                        </td>
                    </tr>
                </table>
            </td>
...
const getTemplateRecover = (email, token) => {
  return `
  <head>
              ...
              <table width="600" style="background-color: #ffffff; border: 1px solid #e6e6e6; border-radius: 4px; box-shadow: 0 0 10px rgba(0,0,0,0.1);">
                  ...
                  <tr>
                      <td style="padding: 20px;">
                          ...
                          <p><a href="http://localhost:5173/cambiar-contrasena/${token}" style="background-color: rgb(232,191,86); color: #fff; padding: 10px 20px; text-decoration: none; border-radius: 4px;">Restablecer Contraseña</a></p>
                          <p>Si no has solicitado esta recuperación de contraseña, puedes ignorar este correo electrónico.</p>
                      </td>
                  </tr>
                  <tr>
                      <td style="background-color: #f4f4f4; padding: 20px; text-align: center;">
                          <p>Si tienes algún problema al hacer clic en el botón de recuperación, copia y pega el siguiente enlace en tu navegador: http://localhost:5173/cambiar-contrasena/${token}</p>
                      </td>
                  </tr>
              </table>
          </td>
